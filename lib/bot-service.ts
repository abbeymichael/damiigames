...
export const botService = {
  ...
  async executeVerifiedSystemBotTransfer(params: {
    ...
    const ledgerInputs = [
      {
        ...
        metadataJson: JSON.stringify({
          ...
          balanceBefore,
          balanceAfter,
          note: params.note || (params.direction === "credit" ? "System mechanics bankroll allocation" : "System mechanics balance reclaim"),
          timestamp: new Date().toISOString(),
        }),
      },
      {
        userId: "mechanics-treasury",
        accountType: "available" as const,
        entryType: params.direction === "credit" ? "withdrawal" : "deposit",
    ...
    try {
      await dbRepository.createTransaction({
        ...
        metaJson: JSON.stringify({
          ...
          paymentRef: params.paymentRef || null,
          note: params.note || (params.direction === "credit" ? "System verified mechanic bankroll injection" : "System mechanic bankroll reclaim to treasury"),
          balanceBefore,
          balanceAfter,
    ...
    return {
      ...
      balanceBefore,
      balanceAfter,
      sourceAccount: params.direction === "credit" ? "mechanics-treasury" : "available",
      targetAccount: params.direction === "credit" ? "available" : "mechanics-treasury",
      adminExecutor: adminUser,
      invariantsChecked: {
